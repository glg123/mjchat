...
trait GeneralTrait
{
 use notifcationTrait;
    ...
    public function getUserID($token){
        ...
        $id=DB::table('appusers')->where('api_token','=',$token)->value('id');
    ...
    public function sendNotfication($userID,$orderID,$msg){
  ...
  public function sendNotficationxxxx($userID,$orderID,$msg){
        $tokens=[];
         foreach ($userID as $single){
             $usertoken=DB::table('fcm_tokens')->where('user_id','=',$single->id)->value('device_token');
