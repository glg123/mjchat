    ...
    @else
        ...
        <head>
            ...
            @if(app()->getLocale() === "en")
                ...
                <link href="{{asset('admin_assets/css/demo1/style.bundle.css')}}" rel="stylesheet" type="text/css"/>
            @else
                ...
                <link href="{{asset('admin_assets/css/demo1/style.bundle.rtl.css')}}" rel="stylesheet" type="text/css"/>
                ...
                <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop"
                    ...
                    <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                        <div class="kt-aside__brand-logo">
                            <a href="{{$dashboard_index}}">
                                @if(app()->getLocale() === "en")
                                    <img class="image-fluid" alt="Logo" src="{{asset('img/logo.png')}}"
                        ...
                        <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1"
                            ...
                            <ul class="kt-menu__nav ">
                                ...
                                @foreach($menu_list as $menu_item )
                                            ...
                                            <div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
                                                <ul class="kt-menu__subnav">
                                                    @foreach($menu_item['children'] as $menu_child )
                                                        <li class="kt-menu__item {{ $menu_child['is_active'] ? 'kt-menu__item--active' : '' }}"
                                    ...
                                    @else
                                        <li class="kt-menu__item {{ $menu_item['is_active'] ? 'kt-menu__item--active' : '' }}"
                                            aria-haspopup="true">
                                    ...
                                    <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                                        ...
                                        @foreach($lang_list as $lang_item )
                                            <li class="kt-nav__item {{$lang_item['code'] === app()->getLocale() ? 'kt-nav__item--active' : ''}}">
                                                <a href="{{ route('lang.switch', $lang_item['code']) }}"
                                                   class="kt-nav__link">
                            ...
                            <div class="kt-header__topbar-item kt-header__topbar-item--user">
                                <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
                                    <div class="kt-header__topbar-user">
                                        ...
                                        <span
                                            class="kt-header__topbar-username kt-hidden-mobile">{{auth()->guard('Admin')->user()->name}}</span>
                                        <span
                                            class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bold">{{mb_substr(auth()->guard('Admin')->user()->name, 0, 1)}}</span>
                                    </div>
                                </div>
                                <div
                                    ...
                                    <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x">
                                        <div class="kt-user-card__avatar">
                                            <span
                                                class="kt-badge kt-badge--lg kt-badge--rounded kt-badge--bold kt-font-success">{{mb_substr(auth()->guard('Admin')->user()->name, 0, 1)}}</span>
                                        </div>
                                    ...
                                    <div class="kt-notification">
                                        ...
                                        <div class="kt-notification__custom kt-space-between">
                                            &nbsp;
                                            <a data-confirm="{{__('views.Are you sure?')}}" data-csrf="{{csrf_token()}}"
                                               data-method="post" data-to="{{$logout_url}}" href="{{$logout_url}}"
                                               rel="nofollow">
                                                {{__('views.Sign Out')}}
                                            </a>
                                        </div>
        ...
        <script src="{{asset('admin_assets/plugins/custom/fullcalendar/fullcalendar.bundle.js')}}"
