                                ...
                                <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround">
                                    <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                                        ...
                                        <li class="kt-nav__item {{$lang_item['code'] === app()->getLocale() ? 'kt-nav__item--active' : ''}}">
                                            <a href="{{ route('lang.switch', $lang_item['code']) }}" class="kt-nav__link">
                                ...
                                <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                                    ...
                                    <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x">
                                        <div class="kt-user-card__avatar">
                                            <span class="kt-badge kt-badge--lg kt-badge--rounded kt-badge--bold kt-font-success">{{mb_substr(auth()->guard('Admin')->user()->name, 0, 1)}}</span>
                                        </div>
