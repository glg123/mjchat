                ...
                <div class="kt-form kt-form--label-align-right kt-margin-t-20 collapse"
                    ...
                    <div class="row align-items-center">
                                    ...
                                    <div class="m-form__group m-form__group--inline">
                                        ...
                                        <div class="m-form__control">
                                            <select style="opacity: 1 !important;"
                                                ...
                                                <option value="2">{{__('views.Not_Active')}}</option>
                                                <option value="3">{{__('views.Block')}}</option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                            ...
                            <a style=""
                               class="btn btn-primary m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill event"
                               id="block">
                                      <span>

                                        <span>{{__('views.Block')}}</span>
                                    </span>
                            </a>
