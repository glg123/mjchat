            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
                <div class="kt-login__container">
                    <div class="kt-login__logo">
                        <a href="#">
                            <img src="{{url('icon.png')}}" class="img-fluid">
                        </a>
                    </div>
...
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD_oOfYaJUc053XgD0w4hw9tXBtbmZ0F3Q&sensor=false&libraries=places"></script>
